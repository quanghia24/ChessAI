...
class Game:
    ...
    def start_game_with_autoplay(self):
        self.autoplay = True
        self.game_screen()
    ...
    def menu_screen(self):
        ...
        menu.add.selector('Level: ', [('Medium', 6), ('Hard', 10), ('Easy', 3)], onchange=self.set_level)


        menu.add.button('Play', self.game_screen)
        menu.add.button('AI vs Random', lambda: self.start_game_with_autoplay())
    ...
    def determine_move(self):
        ...
        if self.p2_name == "Minimax":
            self.ai_move.put(AI.minimax(self.board.copy(), self.level, inf, -inf, True, self.p2_color)[0])
        else:
    ...
    def game_screen(self):
        ...
        while True:
            ...
            # Self-play
            if self.autoplay and self.board.turn == self.p1_color:
    ...
    def draw_names(self):
        ...
        p1name = FONT.render(str(self.p2_name), True, SMALL_TEXT_COLOR)
        ...
        p2name = FONT.render(str(self.p1_name), True, SMALL_TEXT_COLOR)
